...
class ReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Конвертируем в Carbon объекты для удобства
        ...
        // 2. Убытки (claims) по договорам компании
        ...
        // 3. Платежи по договорам компании
        ...
        $charts = [
            ...
            // Ежемесячная динамика договоров
            'contracts_monthly' => $this->getMonthlyData($allContracts, $start, $end),
            
            // Распределение платежей по типам
            'payments_by_type' => [
...
public function exportPdf(Request $request)
{
    ...
    // Собираем все данные для передачи в шаблон
    $data = [
        'stats' => $stats,
    ...
    // Для обратной совместимости добавляем и старые ключи
    ...
    /**
     * Генерация данных для ежемесячного графика договоров
     */
    ...
    /**
     * Генерация данных для ежемесячного графика платежей
     */
